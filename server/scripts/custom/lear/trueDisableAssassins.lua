...
dbAssassinsConfig.levelRequirement = 1 -- This sets the level required to spawn an Assassin when a player uses a bed.
dbAssassinsConfig.spawnChance = 50 -- This is the percentage that an Assassin will spawn when the above set leveled player uses a bed.
					-- Example: Set this to 100 for 100% chance, 50 for a 50% chance, etc. and 0 for Assassins to never spawn.
dbAssassinsConfig.onlySpawnOnce = false -- When true, players will only be attacked by assassins once.
